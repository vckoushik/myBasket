<?php
	...
	$name = "koushik";
	$from ="koushiksiva9@gmail.com";
	$phone = "9494494944";
	$subject = stripslashes( nl2br( "Your order is placed" ) );
	$message = stripslashes( nl2br("Order placed" ) );
	// $headers ="koushiksiva9@gmail.com <$from>\n";
